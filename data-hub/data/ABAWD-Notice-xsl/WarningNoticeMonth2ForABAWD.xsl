...
<xsl:stylesheet exclude-result-prefixes="xsd functx an" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--<xsl:variable name="notice-details" as="element(an:abawd-notices)">
        <an:abawd-notices xmlns:an="info:md/dhr/abawd/notices#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
            <an:notification-core>
                ...
                <an:clientLanguagePreferenceCode>am</an:clientLanguagePreferenceCode>
            ...
            <an:notice xsi:type="WarningNoticeMonth-2">
                <an:provide-proof-date>2016-05-05</an:provide-proof-date>
            </an:notice>
        </an:abawd-notices>
    </xsl:variable>-->
   ...
   <xsl:output method="xml" indent="yes"/>
    ...
    <xsl:function name="an:createProofDate">
 ...
 <!-- Default template.  The default is not to output anything unless it has been specifically called. -->
    ...
    <xsl:template name="createBody">
        <xsl:variable name="thisproofdate" select="$notice-details//an:provide-proof-date/normalize-space() cast as xs:date"/>
        <xsl:variable name="thislang" select="$notice-details//an:clientLanguagePreferenceCode/normalize-space()"/>
        <fo:block space-before=".25in" break-after="page">
            <xsl:choose>
                <xsl:when test="$thislang eq 'am' ">
                    <xsl:call-template name="createBody-am">
                        <xsl:with-param name="thisproofdate" select="$thisproofdate"/>
    ...
    <xsl:template name="createBody-am">
        ...
        <fo:block space-before=".15in">ከላይ ከተጠቀሱት ሁኔታዎች አንዱም የማይመለከትዎ ከሆኑየተጨማሪ ምግብ እርዳታዎችን ማግኘትዎን ለመቀጠል በሳምንት ቢያንስ ለ20 ሰዓታት ያክል ክፍያ የሚያገኙበትን ሥራ መስራት አለብዎት ወይም ወይም ተቀባይነት ባለው የሥራ እንቅስቃሴ ውስጥ መሳተፍ አለብዎት። በግል ሥራዎ ላይ ከተሰማሩ በሳምንት ቢያንስ ለ30 ሰዓታት ያክል ሥራ መስራት አለብዎት። ሥራ እንዳለዎት ወይም በሥራ እንቅስቃሴ ውስጥ በመሳተፍ ላይ እንደሆኑ የሚያሳይ ማስረጃ እስከ <fo:inline text-decoration="underline"><fo:inline margin-left="12px">&#160;</fo:inline><xsl:value-of select="an:createProofDate($thisproofdate, $thislang)"/><fo:inline margin-right="12px">&#160;</fo:inline></fo:inline> ድረስ ማቅረብ አለብዎት፤ አለበለዚያ ቀጣዩ ወር ተጨማሪ የምግብ እርዳታ የሚያገኙበት የመጨረሻው ወር ይሆናል።</fo:block>
    ...
    <xsl:template name="createBody-ar">
        ...
        <fo:block-container xml:lang="ar" writing-mode="rl-tb">
            ...
            <fo:block space-before=".15in" xml:lang="ar">إذا لم تنطبق أي من هذه الشروط عليك ، يتوجب عليك العمل لقاء أجر لمدة 20 ساعة في الأسبوع على الأقل ، أو التسجيل في أحد "أنشطة القوى العاملة"  المعتمدة وذلك حتى تتمكن  من الإستمرار في الحصول على مستحقاتك من برنامج الغذاء التكميلي .  إذا ما كانت أيا من الشروط المذكورة أعلاه  تنطبق عليك ، الرجاء الاتصال بنا فوراً . أما إذا لم تستوفي أيا من الشروط ، فيمكنك تلقي المستحقات مرة أخرى إذا ما أعدت تقديم طلب وتثبت فيه أنك تعمل لمدة  20 ساعة في الأسبوع على الأقل ، أو إذا ما كان لديك دليل على أنك قد سجلت في أحد "أنشطة القوى العاملة" المُعتمد . أما إذا ما كُنت تعمل لحسابك الشخصي ، فعليك أن تعمل 30 ساعة في الأسبوع على الأقل . يتوجب عليك تقديم إثبات يدل على عملك أو نشاط عملك في موعد أقصاه <fo:inline text-decoration="underline"><fo:inline margin-left="12px">&#160;</fo:inline><xsl:value-of select="an:createProofDate($thisproofdate, $thislang)"/><fo:inline margin-right="12px">&#160;</fo:inline></fo:inline>، وإلا سيكون الشهر القادم هو آخر شهر تحصل فيه على مستحقاتك من برنامج الغذاء التكميلي .</fo:block>
    ...
    <xsl:template name="createBody-en">
        ...
        <fo:block space-before=".15in">If none of the above situations applies to you, then you must work for pay for at least 20 hours per week or enroll in an approved work activity in order to continue your Food Supplement benefits. If you are self-employed, you must work for at least 30 hours per week.  You must provide proof of your employment or work activity by <fo:inline text-decoration="underline"><fo:inline margin-left="12px">&#160;</fo:inline><xsl:value-of select="an:createProofDate($thisproofdate, $thislang)"/><fo:inline margin-right="12px">&#160;</fo:inline></fo:inline> or else next month is the last month you can receive Food Supplement benefits.</fo:block>
    ...
    <xsl:template name="createBody-es">
        ...
        <fo:block space-before=".15in">Si ninguna de las situaciones mencionadas arriba aplica a su caso, usted tiene que trabajar por lo menos 20 horas semanales o inscribirse en una actividad laboral aprobada para poder seguir recibiendo los beneficios de Suplementos Alimenticios. Si trabaja por cuenta propia, usted tiene que trabajar por lo menos 30 horas semanales.  Usted tiene que presentar pruebas de su empleo o actividad laboral a más tardar el <fo:inline text-decoration="underline"><fo:inline margin-left="12px">&#160;</fo:inline><xsl:value-of select="an:createProofDate($thisproofdate, $thislang)"/><fo:inline margin-right="12px">&#160;</fo:inline></fo:inline>.  <fo:inline text-decoration="underline">De lo contrario el próximo mes será el último mes en que usted podrá recibir los beneficios de Suplementos Alimenticios</fo:inline>.</fo:block>
